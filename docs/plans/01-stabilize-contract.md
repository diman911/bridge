...
**Status:** Done — 2026-09-22, see "Resolution notes" below. The field-level `IntegrationCommand` it stabilized is superseded for the extension-facing wire by the narrow contract in [07-report-envelope-and-versioning.md](07-report-envelope-and-versioning.md); `Connector`/`IntegrationResult` remain the connector-side contract.
